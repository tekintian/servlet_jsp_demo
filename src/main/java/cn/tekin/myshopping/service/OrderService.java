...
public class OrderService {
	...
	public void submitOrder(MyCart myCart,Users user){
        ...
        //for mysql
        String sql = "insert into orders(userId,totalPrice,orderDate) values(?,?,current_date)";
		...
		try {
            ...
            //在已预处理增加  Statement.RETURN_GENERATED_KEYS 为了返回最后插入时自动生成的 ID；
            ...
            for (int i = 0; i < al.size(); i++) {
                ...
                sql="insert into orderitem(ordersId,bookId,bookNum) values (?,?,?)";
